 ...
 */
class OauthClients extends \Application\Entity\OauthClients implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\OauthClients' . "\0" . 'clientId', '' . "\0" . 'Application\\Entity\\OauthClients' . "\0" . 'clientSecret', '' . "\0" . 'Application\\Entity\\OauthClients' . "\0" . 'redirectUri', '' . "\0" . 'Application\\Entity\\OauthClients' . "\0" . 'grantTypes', '' . "\0" . 'Application\\Entity\\OauthClients' . "\0" . 'scope', '' . "\0" . 'Application\\Entity\\OauthClients' . "\0" . 'userId'];
        }
